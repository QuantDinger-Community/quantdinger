...
| File | Purpose |
|------|---------|
| [`openapi.yaml`](openapi.yaml) | Committed SSOT â€” update via `backend/scripts/export_openapi.py` |
| [`index.html`](index.html) | Static Redoc viewer â€” **must be served over HTTP** (see below) |
